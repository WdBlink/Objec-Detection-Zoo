...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           ...
           'wide_resnet50_2', 'wide_resnet101_2', 'resnet_transformer']
...
class ResNet(nn.Module):
    ...
    def __init__(
        self,
        block: Type[Union[BasicBlock, Bottleneck, BottleneckBlock]],
        layers: List[int],
    ...
    def _make_layer(self, block: Type[Union[BasicBlock, Bottleneck, BottleneckBlock]], planes: int, blocks: int,
