...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/mnt/e/github/object-detection-zoo/runs/train/faster_rcnn.pkl', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/mnt/e/datasets/tmp/Production_ORTH4_ortho_part_5_2', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--project', default='runs/detect/Faster-Rcnn-resnet50', help='save results to project/name')
    parser.add_argument('--name', default='airplane', help='save results to project/name')
