...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/HRSC_VOC.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/yolov5l11/weights/last.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='HRSC', help='save to project/name')
