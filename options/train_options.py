...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--weights', nargs='+', type=str,
                            default='/mnt/e/github/yolov5-master/runs/train/Faster-Rcnn-mobilenetv32/last.pkl',
        ...
        parser.add_argument('--rcnn-batch-size', default=2, type=int)
        ...
        parser.add_argument('--project', default='runs/detect/Faster-Rcnn-mobilenetv3',
