...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/mnt/e/datasets/tmp/', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--output', type=str, default='/mnt/e/datasets/tmp/', help='path to cropped images')
    parser.add_argument('--imgsz', type=int, default='1000', help='cropped images size')
